...
// Added for printing CS 3505 statement only ONCE.
...
static int gif_read_image(GifState *s, AVFrame *frame)
{
    ...
    if (!PRINT_COUNTER)
    {
        av_log(NULL, AV_LOG_INFO, "\n*** CS 3505 Spring 2019:  Running code in gif_read_image in ./libavcodec/gifdec.c ***\n*** CS 3505 Spring 2019:  Changed by Harrison Quick and Kris Wolff ***\n\n");
        PRINT_COUNTER++;
    }
